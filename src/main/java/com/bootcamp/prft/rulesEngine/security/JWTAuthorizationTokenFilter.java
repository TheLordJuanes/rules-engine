...
package com.bootcamp.prft.rulesEngine.security;
...
public class JWTAuthorizationTokenFilter extends OncePerRequestFilter {
    ...
    private static final String[] excludedPaths = {"POST /signIn", "GET /signIn", "GET /login", "POST /login", "GET /signUp", "POST /api/v1/users", "GET /logout", "POST /api/v1/table", "GET /api/v1/table"};
