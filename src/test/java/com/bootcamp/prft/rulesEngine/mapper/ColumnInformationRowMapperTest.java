...
public class ColumnInformationRowMapperTest {
    ...
    public void testMapRow(){
        String sql = " SELECT table_name, column_name, data_type FROM information_schema.columns WHERE table_name = 'TATABROS_TEST'";
        ...
        assertEquals("TATABROS_TEST", columnInformationList.get(0).getTableName());
        assertEquals("ID", columnInformationList.get(0).getColumnName());
        assertEquals("UUID", columnInformationList.get(0).getDataType());

        assertEquals("TATABROS_TEST", columnInformationList.get(1).getTableName());
        ...
        assertEquals("TATABROS_TEST", columnInformationList.get(2).getTableName());
        ...
        assertEquals("TATABROS_TEST", columnInformationList.get(3).getTableName());
        ...
        assertEquals("TATABROS_TEST", columnInformationList.get(4).getTableName());
        assertEquals("AGE", columnInformationList.get(4).getColumnName());
        assertEquals("INTEGER", columnInformationList.get(4).getDataType());

        assertEquals("TATABROS_TEST", columnInformationList.get(5).getTableName());
        ...
        assertEquals("TATABROS_TEST", columnInformationList.get(6).getTableName());
        ...
        assertEquals("TATABROS_TEST", columnInformationList.get(7).getTableName());
        ...
        assertEquals("TATABROS_TEST", columnInformationList.get(8).getTableName());
